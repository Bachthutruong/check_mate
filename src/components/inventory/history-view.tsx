            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="hidden lg:table-cell">Items Checked</TableHead>
                  <TableHead className="hidden lg:table-cell">Missing Items</TableHead>
                      ...
                      <TableRow key={check._id}>
                        ...
                        <TableCell className="text-right">
                          <div className="flex flex-col gap-2 items-end">
                            {/* Mobile view for counts */}
                            <div className="lg:hidden text-xs">
                              <div className="text-green-600">✓ {checkedCount}</div>
                              {missingCount > 0 && (
                                <div className="text-red-600">⚠ {missingCount}</div>
                              )}
                            </div>
